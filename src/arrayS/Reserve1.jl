...
#=▶=# function add7(m, t::Int, T::Int, s, GD, r0, δ0) # this t2T is simply the planning horizon
    Ramp = GD.Ramp
    for t=t+1:T, s=s, z=GD.Zone, g=eachindex(GD.N[z])
        _2(m, r0[t,s,z,g], δ0[t,s,z,g,1], δ0[t,s,z,g,0], Ramp[1][z][g], Ramp[0][z][g])
    end
end
